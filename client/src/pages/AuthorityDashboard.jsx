...
const AuthorityDashboard = () => {
  ...
  return (
    <div className="w-full h-full bg-transparent min-h-screen space-y-6 md:pt-0 md:pb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="bg-white p-4 md:p-6 rounded-2xl shadow-md">
          ...
          {posts.slice(0, 5).map((p) => (
            ...
            <div
              key={p.id}
              className="flex justify-between py-2 border-b text-sm gap-3"
            >
      ...
      {/* TABLE */}
      <div className="bg-white p-4 md:p-6 rounded-2xl shadow-md overflow-hidden">
            ...
            <tbody>
              ...
              {posts.map((post) => (
                ...
                >
                  ...
                  <td className="py-3 max-w-[140px] truncate">
                    {post.content}
                  </td>
